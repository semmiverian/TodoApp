...
public class RobotoTextButton extends Button {
	...
	public RobotoTextButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		if (isInEditMode()) return;
		parseAttributes(attrs);
	}

	public RobotoTextButton(Context context, AttributeSet attrs, int defStyle) {
